...
const DashboardNavbar: React.FC = () => {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      ...
      // Set up polling for both notifications every 30 seconds
  ...
  }, [isAuthenticated, fetchNotifications, fetchReturnNotificationsData]);
        ...
        {isAuthenticated && user ? (
          <>
            ...
            <div className="relative dropdown-container">
              ...
              >
                <Bell size={25} />
                {(unreadCount > 0 || returnNotificationsCount > 0) && (
                  <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                    {unreadCount + returnNotificationsCount > 99
                      ? "99+"
                      : unreadCount + returnNotificationsCount}
                  </span>
                )}
              </button>
