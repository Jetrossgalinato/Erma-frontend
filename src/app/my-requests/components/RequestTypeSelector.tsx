  ...
  return (
    <div className="relative inline-block">
      <select
        ...
        className="appearance-none bg-white border border-gray-300 text-gray-700 py-2 pl-4 pr-10 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base font-medium cursor-pointer hover:border-gray-400 transition-colors"
      >
